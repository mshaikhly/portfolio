        ...
        <div>
            <section className="w-full py-20">
                <h1 className="heading">
                    My <span className="text-purple">work ethic principles</span>
                </h1>
                <div className="my-20 flex flex-col lg:flex-row items-center justify-center w-full gap-4">
                    <Card
                        title="Effective Communication"
                        icon={<AceternityIcon order="Principle 1" />}
                        description="I prioritize clear and consistent communication, ensuring that all stakeholders are aligned on project goals, timelines, and progress."
                    >
                        <CanvasRevealEffect
                            animationSpeed={5.1}
                    ...
                    <Card
                        ...
                        description="I approach challenges with a solutions-oriented mindset, adapting to new technologies and evolving project requirements with ease."
                    >
                        <CanvasRevealEffect
                            animationSpeed={3}
                    ...
                    <Card
                        ...
                        description="I thrive in collaborative environments, working closely with cross-functional teams to achieve collective goals and deliver high-quality outcomes."
                    >
                        <CanvasRevealEffect
                            animationSpeed={3}
                    ...
                    <Card
                        ...
                        icon={<AceternityIcon order="Principle 4" />}
                        description="I am committed to personal and professional growth, continuously refining my skills and staying updated with the latest industry trends."
                    >
                        <CanvasRevealEffect
                            animationSpeed={3}
